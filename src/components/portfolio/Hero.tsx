      ...
      <div className="relative mx-auto max-w-6xl px-4 sm:px-6 grid md:grid-cols-[1.2fr_1fr] gap-10 md:gap-16 items-center">
        <div className="animate-fade-up">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            ...
            <a href="/resume.pdf" className="inline-flex items-center gap-2 rounded-full px-5 py-3 text-sm font-medium text-muted-foreground hover:text-foreground transition-colors">
