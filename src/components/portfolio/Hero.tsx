      ...
      <div className="relative mx-auto max-w-6xl px-4 sm:px-6 grid md:grid-cols-[1.2fr_1fr] gap-10 md:gap-16 items-center">
        <div className="animate-fade-up">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            ...
            <a href="https://withered-river-234.linkyhost.com" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 rounded-full px-5 py-3 text-sm font-medium text-muted-foreground hover:text-foreground transition-colors">
